  ...
  return (
    <PopoverPrimitive.Portal>
      ...
      <PopoverPrimitive.Positioner sideOffset={8} {...props.options}>
        <PopoverPrimitive.Popup {...props} className={cn("bg-white dark:bg-neutral-800 rounded-2xl p-4 border border-neutral-200 dark:border-neutral-700 shadow-sm max-w-xs transition-[transform,scale,opacity] data-[ending-style]:scale-[0.95] data-[ending-style]:opacity-0 data-[starting-style]:scale-[0.95] data-[starting-style]:opacity-0", props.className)}  />
